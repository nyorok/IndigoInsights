...
class LiquidityPoolYield {
  ...
  factory LiquidityPoolYield.fromJson(Map<String, dynamic> json) {
    return LiquidityPoolYield(
      dex: _dexNameToEnum(json['dex'] as String),
      assetA: _assetIdToName(json['asset_a'] as String),
      assetB: _assetIdToName(json['asset_b'] as String),
      tradingFeesApr: (json['base_apr'] as num).toDouble(),
