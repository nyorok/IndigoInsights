...
class StrategiesOverview extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final maxCardHeight = screenWidth - 480 > 480
        ? screenHeight - 65
        : screenHeight;
                ...
                Text.rich(
                  TextSpan(
                    ...
                    children: [
                      const TextSpan(
                        text:
                            'Strategy Insights offers a deep dive into various yield-generating opportunities within the Indigo Protocol ecosystem.\n\n',
                      ),
