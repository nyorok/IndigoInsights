...
class AdaDoubleLeverageAboveMrContent extends StatefulWidget {
  const AdaDoubleLeverageAboveMrContent({super.key});

  @override
  State<AdaDoubleLeverageAboveMrContent> createState() =>
      _AdaDoubleLeverageAboveMrContentState();
}

class _AdaDoubleLeverageAboveMrContentState
    extends State<AdaDoubleLeverageAboveMrContent> {
