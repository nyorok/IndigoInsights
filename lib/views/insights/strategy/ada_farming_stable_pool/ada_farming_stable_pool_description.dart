...
class AdaFarmingStablePoolDescription extends StatelessWidget {
  const AdaFarmingStablePoolDescription({super.key});
        ...
        child: Text.rich(
          TextSpan(
            ...
            children: [
              ...
              const TextSpan(
                text: 'earning rewards from Stable Pools (DEX)',
              ...
              const TextSpan(
                text: 'Provide liquidity to Stable Pools (DEX):',
                style: TextStyle(fontWeight: FontWeight.bold),
              ),
              const TextSpan(
                text:
                    ' You then use your newly minted iAsset to provide liquidity in a stable pool on a DEX (Minswap, etc) to earn trading fees.\n',
              ),
              const TextSpan(text: '3.  '),
              const TextSpan(
                text: 'Stake your LP tokens to earn additional farm rewards:',
                style: TextStyle(fontWeight: FontWeight.bold),
              ),
              const TextSpan(
                text:
                    ' Finally, you can stake your minted LP tokens to earn additional farm rewards.\n\n',
              ),
              const TextSpan(
                text:
              ...
              const TextSpan(
                text:
                    'So, you\'re earning yield from your DEX liquidity, farming rewards and your original ADA collateral. ',
              ),
              const TextSpan(text: 'Your net gain is the stable pool '),
              ...
              const TextSpan(
                text:
                    ': When providing liquidity in a DEX stable pool, impermanent loss can occur if the price ratio between the iAsset and the stablecoin changes. While stablecoins are designed to maintain their peg, significant market volatility or iAsset depegs can lead to this type of loss. ',
              ),
              const TextSpan(
                text:
                    'Monitor the iAsset\'s peg closely against its underlying asset.',
                style: TextStyle(fontWeight: FontWeight.bold),
              ),
              const TextSpan(text: '\n\n'),
              const TextSpan(text: '• ', style: TextStyle(letterSpacing: 2)),
