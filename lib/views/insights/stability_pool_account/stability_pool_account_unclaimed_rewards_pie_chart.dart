...
final stabilityPoolAccountUnclaimedRewardsProvider =
    FutureProvider.family<List<double>, String>((ref, asset) async {
      ...
      return await ref
          .watch(stabilityPoolAccountProvider.future)
          .then(
            (value) => value
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    getAccountUnclaimedRewardsData(List<double> accountsUnclaimedRewards) {
      ...
      final bigAmount = accountsUnclaimedRewards
          ...
          .toList();
      final smallerAmounts = accountsUnclaimedRewards.where(
        (e) => e / totalSum < 0.01,
      );
    ...
    return ref
        .watch(stabilityPoolAccountUnclaimedRewardsProvider(asset))
        .when(
          data: (accountsUnclaimedRewards) {
            final accountsUnclaimedRewardsData = getAccountUnclaimedRewardsData(
              accountsUnclaimedRewards,
            );
