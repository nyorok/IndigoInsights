...
import 'package:indigo_insights/views/insights/staking_rewards/staking_rewards_chart.dart';
import 'package:indigo_insights/views/insights/staking_rewards/staking_rewards_information.dart';

class StakingRewardsInsights extends HookConsumerWidget {
  const StakingRewardsInsights({super.key});
          ...
          child: Align(
            ...
            child: Wrap(
              children: [
                Column(
                  children: [
                    informationCard(const StakingRewardsInformation(), context),
                  ],
                ),
                chartCard(const StakingRewardsChart(), context)
              ],
            ),
          ),
        ),
